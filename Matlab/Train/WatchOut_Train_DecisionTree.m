...
%% inital
FileDir = ['MobilePhoneSensor\' Phones{PhoneChoice} '\' Userz{UserCount}];
URFileDir = cat(2,FileDir, 'UpRamp');
DRFileDir = cat(2,FileDir, 'DownRamp');
disp([Userz{UserCount}(1:end-1) '; NFold = ' num2str(NFold)]);
HaveStepFile = true;
Temp = strfind(FileDir,'\');
if isempty(Temp)
    Temp = strfind(FileDir,'/');
end
UserName = FileDir(Temp(end - 1) + 1 : Temp(end)-1);
PhoneType = FileDir(Temp(end - 2) + 1 : Temp(end - 1) - 1);
if isempty(strfind(FileDir,'Mi'))
    SampleRate = 100;
else
    SampleRate = 200;
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1
%             binary_tree = fitctree(x_binary_train, y_binary_train,...
...
%             'ScoreTransform','doublelogit');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2
    binary_tree = fitctree(x_train_selected, y_binary_train);%,...
...
%             'ScoreTransform','doublelogit');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3
%         advanced_tree{ClassCount} = fitctree(x_advanced_train, y_advanced_train...
...
%             'ScoreTransform','doublelogit');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%4
    AdvancedTree = fitctree(x_advanced_train_selected, y_advanced_train);%...
